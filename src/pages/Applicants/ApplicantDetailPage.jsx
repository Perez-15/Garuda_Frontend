...
export default function ApplicantDetailPage() {
  ...
  // ── Permission check ────────────────────────────────────────────────────
  // Mirrors the backend canModify() logic so the UI hides actions proactively.
  ...
  // canModify is derived once the applicant is loaded
  const canModify = applicant
    ? isAdmin || (isTA && (int(applicant.created_by?.id) === int(currentUser?.id)))
    : false;

  // Simple int cast helper to avoid loose == issues
  ...
  const handleStatusChange = async (newStatus) => {
    const labels = { pooling: 'Pooling', active: 'In-Process' };
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="flex items-center space-x-4 mt-2">
              ...
              {/* Read-only badge for TA viewing someone else's applicant */}
              {!canModify && (
          ...
          {/* Delete — only shown if user can modify */}
          {canModify && (
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                {/* Edit button — only if user can modify and not already editing */}
                {canModify && !isEditing && (
                  <button
              ...
              {/* Always show read view; edit form only when canModify + isEditing */}
              {isEditing && canModify ? (
                ...
                <div className="space-y-3">
                  ...
                  {/* Added by — helpful context when viewing someone else's applicant */}
                  {applicant.created_by && (
                    <div className="flex items-center text-gray-500 text-sm pt-1 border-t border-gray-100">
                      <User className="h-4 w-4 mr-3 flex-shrink-0 text-gray-400" />
                      <span>Added by <span className="font-medium text-gray-700">{applicant.created_by.name}</span></span>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                {/* Step controls — only for active applicants the user can modify */}
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              {/* Note form — only shown if user can modify */}
              {canModify && (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              {/* Hired state — everyone can see this, no actions needed */}
              {isHired ? (
                ...
                /* Action buttons — only for users who can modify */
                <div className="space-y-2">
                  {canConvert && (
                    <button
                ...
                /* View-only notice for TA viewing someone else's applicant */
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-5">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg px-4 py-3 text-xs text-blue-700">
              This will create a new Employee record carrying over the applicant's name, email, contact, branch, and source. Fill in the employment details below.
            </div>
